...
public class MyPageController {
	...
	public String MyPageList(ModelMap model) {
	...
	public String FilePost(MultipartHttpServletRequest request, ModelMap model, HttpSession session) {
		...
		//이미지 파일이 들어갈 경로 설정(각 서버 경로 지정 수정 해야함)
		String path = "C:\\haniumMerge\\hanium-space\\MyC\\WebContent\\fileFolder\\";
		...
		String gal_notice = request.getParameter("gal_notice");
