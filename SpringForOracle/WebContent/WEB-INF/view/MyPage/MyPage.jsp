		...
		<div id="main_container">
			...
			<section class="b_inner">
				...
				<div class="hori_cont">
					...
					<div class="detail">
						<div class="top">
							<div class="user_name"><%=i.getEmail()%></div>
						</div>

						<ul class="middle">
							<li><span>게시물</span> <%
 	max = 0;
 		for (MyPageDTO j : rList)
 			if (max < Integer.parseInt(j.getGal_nb())) {
 				max = Integer.parseInt(j.getGal_nb());
 				out.print(max);
 %> <% 	} else{ } %></li>
						...
						<span>
							<div class="profile_state">
								<%for (MyPageDTO k : rList){ 
										if (CmmUtil.nvl(k.getGal_notice()).equals("1")) 
												out.print(k.getGal_content());
								}
								%>
							</div>
						</span>
						<p style="padding-left: 15%; padding-right: 15%;">
							<span><a href="/MyPage/FileUPdate.do"
								...
								style="text-decoration: none; color: black; padding: 0 10px 0 10px;">상태글등록</a></span>
						</p>
