...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
    <%
	MyPageDTO rDTO = (MyPageDTO) request.getAttribute("rDTO");
	%>
<!DOCTYPE html>
<html>
<head>
...
<meta charset="UTF-8">
<title><%=CmmUtil.nvl(rDTO.getGal_name()) %></title>
</head>
<body>
<header id="header">
...
<div style="width: 800px">
		<h4><%=CmmUtil.nvl(rDTO.getGal_name()) %></h4>
		<hr>
		...
		<div style="float: right;">
			<button onclick="location.href='/MyPage/Galedit.do?no=<%=rDTO.getGal_nb()%>'">편집</button>
		</div>
		<div style="float: right;">
	...
	if(confirm("삭제하시겠습니까?")){
		location.href ="/MyPage/MyPage.do?no=<%=rDTO.getGal_nb()%>";
		}
	}
	</script>
</body>
